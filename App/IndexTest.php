...
class IndexTest extends Database {
    ...
    public function getSondageEnCours ($user){
        ...
        //Pour chaque amis on récupere les sondage qu'il on crée et qui sont toujours en cours
    ...
    //Fonction qui affiche les sondages en cours
    public function getLesSondageEnCours($user){
        
        //selectionne les sondages encore en cours puis les affiche
        $listSondageEnCours = $this->pdo->query("SELECT *
                                                FROM sondage 
